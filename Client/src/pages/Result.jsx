  ...
  return (
    ...
    initial={{ opacity: 0.2, y: 100 }}
      ...
      <div>
        ...
        <p className={!loading ? "hidden" : "text-center mt-2 text-gray-600"}>
          Loading...
        </p>
      </div>
      ...
      {!isImageLoaded && (
        <div className="flex w-full max-w-xl bg-neutral-500 text-white text-sm p-0.5 mt-10 rounded-full">
          <input
            ...
            className="flex-1 bg-transparent placeholder-gray-300 outline-none ml-8 max-sm:w-20"
            type="text"
            placeholder="Describe what you want to generate"
          />
          <button
            type="submit"
            className="bg-zinc-900 px-10 sm:px-16 py-3 text-white rounded-full"
          >
            Generate
          </button>
        </div>
